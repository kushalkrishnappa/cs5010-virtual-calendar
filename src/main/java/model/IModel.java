...
public interface IModel {
   ...
   * The exporter is supplied all the events to transform to its desired form.
   *
   * @param exporter the exporter to use for exporting the string
   * @return string representing the events in the format generated by the exporter
   */
  String exportEventsWithExporter(ICalendarExporter exporter);

  /**
   * Checks if there are any events at a given dateTime.
   *
